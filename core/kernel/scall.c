...
static const struct syscall_entry tee_syscall_table[] = {
    ...
    /* 71 */ SYSCALL_ENTRY(syscall_cryp_psa_obj_generate_key),
    /* 72 */ SYSCALL_ENTRY(syscall_cryp_psa_cipher_operation_init),
    /* 73 */ SYSCALL_ENTRY(syscall_cryp_psa_cipher_encrypt_setup),
    /* 74 */ SYSCALL_ENTRY(syscall_cryp_psa_cipher_decrypt_setup),
    /* 75 */ SYSCALL_ENTRY(syscall_cryp_psa_cipher_generate_iv),
    /* 76 */ SYSCALL_ENTRY(syscall_cryp_psa_cipher_set_iv),
    /* 77 */ SYSCALL_ENTRY(syscall_cryp_psa_cipher_update),
    /* 78 */ SYSCALL_ENTRY(syscall_cryp_psa_cipher_finish),
    /* 79 */ SYSCALL_ENTRY(syscall_cryp_psa_cipher_abort),
    /* 80 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_encrypt),
    /* 81 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_decrypt),
    /* 82 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_operation_init),
    /* 83 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_encrypt_setup),
    /* 84 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_decrypt_setup),
    /* 85 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_generate_nonce),
    /* 86 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_set_nonce),
    /* 87 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_set_lengths),
    /* 88 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_update_ad),
    /* 89 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_update),
    /* 90 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_finish),
    /* 91 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_verify),
    /* 92 */ SYSCALL_ENTRY(syscall_cryp_psa_aead_abort),
    /* 93 */ SYSCALL_ENTRY(syscall_cryp_psa_sign_message),
    /* 94 */ SYSCALL_ENTRY(syscall_cryp_psa_verify_message),
    /* 95 */ SYSCALL_ENTRY(syscall_cryp_psa_sign_hash),
    /* 96 */ SYSCALL_ENTRY(syscall_cryp_psa_verify_hash),
    /* 97 */ SYSCALL_ENTRY(syscall_cryp_psa_asymmetric_encrypt),
    /* 98 */ SYSCALL_ENTRY(syscall_cryp_psa_asymmetric_decrypt),
    /* 99 */ SYSCALL_ENTRY(syscall_cryp_psa_init),
    /*100 */ SYSCALL_ENTRY(syscall_cryp_psa_generate_random),
    /*101 */ SYSCALL_ENTRY(syscall_cryp_psa_destroy_key),
    /*102 */ SYSCALL_ENTRY(syscall_cryp_psa_set_key_usage_flags),
    /*103 */ SYSCALL_ENTRY(syscall_cryp_psa_set_key_algorithm),
    /*104 */ SYSCALL_ENTRY(syscall_cryp_psa_set_key_type),
    /*105 */ SYSCALL_ENTRY(syscall_cryp_psa_set_key_bits),
};
