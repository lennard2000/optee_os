...
#define psa_crypto_init                 __GP11_psa_crypt
#define psa_generate_random             __GP11_psa_generate_random
#define psa_generate_key                __GP11_PSA_GenerateKey
#define psa_destroy_key                 __GP11_psa_destroy_key
#define psa_set_key_usage_flags         __GP11_psa_set_key_usage_flags
#define psa_set_key_algorithm           __GP11_psa_set_key_algorithm
#define psa_set_key_type                __GP11_psa_set_key_type
#define psa_set_key_bits                __GP11_psa_set_key_bits
#define psa_cipher_operation_init       __GP_11_psa_cipher_operation_init
#define psa_cipher_encrypt_setup        __GP_11_psa_cipher_encrypt_setup
#define psa_cipher_decrypt_setup        __GP_11_psa_cipher_decrypt_setup
#define psa_cipher_generate_iv          __GP_11_psa_cipher_generate_iv
#define psa_cipher_set_iv               __GP_11_psa_cipher_set_iv
#define psa_cipher_update               __GP_11_psa_cipher_update
#define psa_cipher_finish               __GP_11_psa_cipher_finish
#define psa_cipher_abort                __GP_11_psa_cipher_abort
#define psa_aead_encrypt                __GP_11_psa_aead_encrypt
#define psa_aead_decrypt                __GP_11_psa_aead_decrypt
#define psa_aead_operation_init         __GP_11_psa_aead_operation_init
#define psa_aead_encrypt_setup          __GP_11_psa_aead_encrypt_setup
#define psa_aead_decrypt_setup          __GP_11_psa_aead_decrypt_setup
#define psa_aead_generate_nonce         __GP_11_psa_aead_generate_nonce
#define psa_aead_set_nonce              __GP_11_psa_aead_set_nonce
#define psa_aead_set_lengths            __GP_11_psa_aead_set_lengths
#define psa_aead_update_ad              __GP_11_psa_aead_update_ad
#define psa_aead_update                 __GP_11_psa_aead_update
#define psa_aead_finish                 __GP_11_psa_aead_finish
#define psa_aead_verify                 __GP_11_psa_aead_verify
#define psa_aead_abort                  __GP_11_psa_aead_abort
#define psa_sign_message                __GP_11_psa_sign_message
#define psa_verify_message              __GP_11_psa_verify_message
#define psa_sign_hash                   __GP_11_psa_sign_hash
#define psa_verify_hash                 __GP_11_psa_verify_hash
#define psa_asymmetric_encrypt          __GP_11_psa_asymmetric_encrypt
#define psa_asymmetric_decrypt          __GP_11_psa_asymmetric_decrypt
#endif
